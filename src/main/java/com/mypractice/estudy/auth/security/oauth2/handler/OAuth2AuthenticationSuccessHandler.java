...
import com.mypractice.estudy.auth.exception.BadRequestException;
...
public class OAuth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    @Autowired
    public OAuth2AuthenticationSuccessHandler(JwtTokenProvider tokenProvider, ApplicationProperties appProperties,
                                       HttpCookiesRequestRepository httpCookieOAuth2AuthorizationRequestRepository) {
    ...
    private boolean isAuthorizedRedirectUri(String uri) {
        ...
        return appProperties.getOauth2Dto().getAuthorizedRedirectUris().stream().anyMatch(authURI -> URI.create(authURI).equals(redirectURI));
